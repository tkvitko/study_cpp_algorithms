...
//
// Реализация хорошей хеш-функции для строки
// Берётся простое число p и число n — модуль. Код каждого символа строки умножается на p в степени индекса этого символа, полученные числа складываются. В конце берётся остаток от деления получившейся суммы на число n.
