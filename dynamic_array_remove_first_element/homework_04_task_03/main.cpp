...
// Реализация удаления первого элемента из динамического массива
...
int* remove_dynamic_array_head(int* arr, int& logical_size, int& actual_size, int& error_code) {
    // удаление первого элемента из динамического массива
    // если элементов после удаления остается меньше, чем треть фактического длины, фактическая длина становится в 3 раза меньше
